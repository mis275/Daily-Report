      ...
      <div className="flex flex-col gap-3 pb-4 border-b border-gray-100">
        <div className="relative w-full">
          <input
            ...
            className="appearance-none w-full bg-white border border-gray-300 rounded-lg pl-4 pr-3 py-2 focus:outline-none focus:ring-2 focus:ring-sky-500 text-sm shadow-sm"
          />
        </div>
        <div className="grid grid-cols-2 gap-2 sm:flex sm:gap-2">
          <input
            ...
            className="appearance-none w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-sm shadow-sm focus:ring-2 focus:ring-sky-500 focus:outline-none min-h-[38px]"
          />
          <input
            type="text"
